...
const PHONE_NUMBER = "5575991093407"
        ...
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false} extraHeight={100}>
            <ScrollView>
                <View className="p-5 flex-1">
                    ...
                    <Input placeholder="Informe o endereco de entrega com rua, bairro, CEP, numero e complemento..."onChangeText={setAddress} onSubmitEditing={handleOrder} blurOnSubmit={true} returnKeyType="next" />
                </View>
            </ScrollView>
